...
(function (n) {
  function v(b, f) {
    ...
    for (c = 0; c < h.length; c++)
      (q = h[c]),
        ...
        window.requestAnimationFrame ||
          ((window.requestAnimationFrame = window[q + 'RequestAnimationFrame']),
          (window.cancelAnimationFrame =
            window[q + 'CancelAnimationFrame'] ||
            window[q + 'CancelRequestAnimationFrame']));
    window.requestAnimationFrame ||
    ...
    a.pointerEnabled
      ? ((a.hasTouch = !1),
        (a._n1 = 0.2),
        (a.pointerMultitouch = Boolean(
          1 < e[(c ? 'm' : 'msM') + 'axTouchPoints']
        )),
        c
          ? k('pointer', 'down', 'move', 'up', 'cancel')
          : k('MSPointer', 'Down', 'Move', 'Up', 'Cancel'))
      : (a.isIOS
          ? (a._j1 = a._k1 = a._l1 = a._m1 = '')
    ...
    a.pointerEnabled &&
      a._p1.css((c ? '' : '-ms-') + 'touch-action', a._h ? 'pan-y' : 'pan-x');
  ...
  v.prototype = {
    ...
    _x2: function (b, f) {
      ...
      if (!c._s2 || e) {
        ...
        c._a3 ||
          ...
          (function h() {
            c._l2 &&
              ((c._t3 = requestAnimationFrame(h)), c._u3 && c._k3(c._u3, f));
          })());
        if (c._l3)
          ...
          ((g = f ? c._e3 : c._h),
          (a =
            Math.abs(a.pageX - c._b3) -
            Math.abs(a.pageY - c._c3) -
            (g ? -7 : 7)),
          7 < a)
        ) {
          ...
          if (0 === w || 1 >= t) a(!0, d);
            ...
            if (f) {
              ...
              if (h > e._n3) h = e._n3;
                ...
                p = e._y3 - e._z3 + e._i3;
                0 < g && m > l
                  ? ((l += e._z3 / (15 / ((m / d) * 0.003))),
                    (d = (d * l) / m),
                    (m = l))
                  : 0 > g &&
                    m > p &&
                    ((p += e._z3 / (15 / ((m / d) * 0.003))),
                    (d = (d * p) / m),
                    (m = p));
      ...
      if (this.slider) {
        if (this.st.autoScaleSlider) {
          ...
          this.st.autoScaleHeight
            ? ((f = this.slider.width()),
              f != this.width &&
                (this.slider.css('height', (e / a) * f),
                (f = this.slider.width())),
              (c = this.slider.height()))
            : ((c = this.slider.height()),
              c != this.height &&
                (this.slider.css('width', (a / e) * c),
                (c = this.slider.height())),
              (f = this.slider.width()));
    ...
    _x3: function (b, f, c, a, e) {
      ...
      d._e
        ...
        : d._l
        ? ((l[d._h ? d._x1 : d._w1] = b + 'px'),
          d._p1.animate(l, d._c, a ? d.st.easeInOut : d.st.easeOut))
        : ((h = d._g4),
          (k = d._r1),
    ...
    _q2: function (b, f) {
      if (!b.isRendered) {
        var c = b.content,
          a = 'rsMainSlideImage',
          e,
          g = n.isFunction(this.st.imageAlignCenter)
            ? this.st.imageAlignCenter(b)
            : this.st.imageAlignCenter,
          d = n.isFunction(this.st.imageScaleMode)
...
(function (f) {
  f.extend(f.rsProto, {
    _h6: function () {
      ...
      'thumbnails' === a.st.controlNavigation &&
        ...
        a.ev.on('rsBeforeParseNode', function (a, b, c) {
          ...
          c.thumbnail.length
            ? (c.thumbnail = f(document.createElement('div'))
                .append(c.thumbnail)
                .html())
    ...
    _k6: function () {
      ...
      b.paddingBottom &&
        (g[a._e3 ? 'paddingBottom' : 'paddingRight'] = b.paddingBottom);
      c.css(g);
      ...
      b._z3 &&
        ...
        b._y3 < b._z3
          ? (b.st.thumbs.autoCenter ? b._q3((b._z3 - b._y3) / 2) : b._q3(b._n3),
            b.st.thumbs.arrows &&
              b._r6 &&
              (b._r6.addClass('rsThumbsArrowDisabled'),
          ...
          : b.st.thumbs.navigation &&
            !b._l6 &&
            ((b._l6 = !0),
            (!b.hasTouch && b.st.thumbs.drag) ||
              (b.hasTouch && b.st.thumbs.touch)) &&
            ((b._m5 = !0),
      ...
      this._l6 &&
        ...
        c !== this._i3 &&
          ...
          b > this._n3
            ...
            : b < this._o3
            ? this._q3(this._o3)
            : void 0 !== c && (e ? this._q3(c) : this._a4(c))),
        this._y6());
    },
  });
  ...
  f.extend(f.rsProto, {
      ...
      if (!a._b7) {
        ...
        d.match(/youtu\.be/i) || d.match(/youtube\.com/i)
          ? ((e = /^.*((youtu.be\/)|(v\/)|(\/u\/\w\/)|(embed\/)|(watch\?))\??v?=?([^#\&\?]*).*/),
            ...
            void 0 !== c && (a._c7 = a.st.video.youTubeCode.replace('%id%', c)))
          : d.match(/vimeo\.com/i) &&
            ((e = /(www\.)?vimeo.com\/(\d+)($|\/)/),
            (e = d.match(e)) && (c = e[2]),
    ...
    _f7: function (a, d) {
      var b = [],
        c = this.st.video;
      c.autoHideArrows &&
        (this._c2 && (b.push(this._c2, this._d2), (this._e2 = !a)),
      ...
      if (a.st.deeplinking.enabled) {
        var g = a.st.deeplinking.change,
          ...
          k = function () {
            ...
            return a &&
              0 < a.indexOf(e) &&
              ((a = parseInt(a.substring(c.length), 10)), 0 <= a)
              ? a - 1
              : -1;
          },
          p = k();
          ...
          a.ev.on('rsAfterSlideChange', function () {
            ...
            f = setTimeout(function () {
              ...
              window.location.replace(
                ('' + window.location).split('#')[0] + c + (a.currSlideId + 1)
              );
  ...
  g = (function () {
    function g() {
      var f = d(),
        e = q(l);
      f !== l
        ? (m((l = f), e), b(a).trigger('hashchange'))
  ...
  d.rsProto._g7 = function () {
    ...
    a.st.visibleNearby &&
      ...
      a.ev.on('rsAfterSizePropSet', function () {
        ...
        a._h
          ? ((a._b4 *= b),
            a._i7.css({ height: a._c4, width: a._b4 / b }),
            (a._d = (a._b4 * (1 - b)) / 2 / b))
          : ((a._c4 *= b),
            a._i7.css({ height: a._c4 / b, width: a._b4 }),
            (a._d = (a._c4 * (1 - b)) / 2 / b));
