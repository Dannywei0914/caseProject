      ...
      var wa,
        ...
        Ca = (O.Transform = function () {
          (this.perspective = parseFloat(g.defaultTransformPerspective) || 0),
            (this.force3D =
              g.defaultForce3D !== !1 && Ba ? g.defaultForce3D || 'auto' : !1);
        }),
        ...
        Ka = function (a, b) {
          ...
          if (
            ...
            return Ja;
          for (
            e = (d || '').match(/(?:\-|\b)[\d\-\.e]+\b/gi) || [], sa = e.length;
            --sa > -1;
          ...
          'transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin',
          {
            parser: function (a, b, c, d, f, h, i) {
              ...
              return (
                ...
                p &&
                  (d._transformType =
                    (j.svg && wa) || (!o && 3 !== this._transformType) ? 2 : 3),
                f
              );
            },
            prefix: !0,
        ...
        ua('backgroundPosition', {
          ...
          parser: function (a, b, c, d, f, g) {
            ...
            if (
              ...
              ((m = X(a, 'backgroundImage').replace(B, '')), m && 'none' !== m)
            ) {
              for (
                h = q.split(' '),
                  i = r.split(' '),
        ...
        for (B = !H || (!F && !G), q = 0; q < E.length; q++) {
          for (
            ...
            'BR' !== k[t].nodeName &&
              ...
              H &&
                (0 === t &&
                  ((y.style.top = w._y + 'px'), (y.style.left = L + x + 'px')),
                (w.style.top = '0px'),
                x && (w.style.left = w._x - x + 'px')));
          0 === j && (y.innerHTML = '&nbsp;'),
            F ||
              G ||
              (y.innerHTML = e(y).split(String.fromCharCode(160)).join(' ')),
            H && ((y.style.width = A), (y.style.height = w._h + 'px')),
            a.appendChild(y);
        }
        a.style.cssText = z;
      }
